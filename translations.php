...
$translations['results']['internalError'] = "Interner Fehler. Falls das Problem bestehen bleibt, kontaktieren sie bitte <a href=\"mailto:it@makerlab-murnau.de?body=Fehlercode: %ERR%; URI: {$_SERVER['REQUEST_URI']}\">it@makerlab-murnau.de</a> (%ERR%)";
